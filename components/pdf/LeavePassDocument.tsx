...
export const LeavePassDocument = ({ leaveRequest }: LeavePassProps) => {
  const parentApproval = leaveRequest.approvals?.find((approval: any) => approval.approver.role === 'PARENT');
  const wardenApproval = leaveRequest.approvals?.find((approval: any) => approval.approver.role === 'WARDEN' || approval.approver.role === 'ADMIN');
        ...
        <View style={styles.signatureSection}>
          ...
          <View style={styles.signatureGrid}>
            <View style={styles.signatureBox}>
              ...
              {parentApproval?.signature?.signature && (
                <Image src={parentApproval.signature.signature} style={styles.signatureImage} />
              )}
